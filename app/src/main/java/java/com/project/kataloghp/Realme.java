...
public class Realme implements Parcelable {
    ...
    public static final Creator<Realme> CREATOR = new Creator<Realme>() {
        @Override
        public Realme createFromParcel(Parcel in) {
            return new Realme(in);
        }

        @Override
        public Realme[] newArray(int size) {
            return new Realme[size];
        }
    };
